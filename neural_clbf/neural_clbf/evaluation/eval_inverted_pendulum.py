...
def plot_inverted_pendulum():
    ...
    ## TODO: Some way to make this agnostic path-wise
    log_file = r"C:\Users\Tetra\Documents\Repostories\OSCorp\Project-Libra\neural_clbf\saved_models\review\inverted_pendulum_clf.ckpt"
